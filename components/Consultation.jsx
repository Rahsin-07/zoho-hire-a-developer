...
const options = [
  {
    ...
    color: '#f97316',
    title: 'Schedule a free 30 minute call',
    ...
    >
      <div
        ...
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(ellipse at 30% 50%,rgba(99,179,237,0.12) 0%,transparent 60%)',
          pointerEvents: 'none',
        }}
      />
      <div
      ...
      <div className="container position-relative">
        <div className="row align-items-center g-5">
          <div className="col-lg-6 fade-up">
            ...
            >
              Tell us your business goals and we'll show you exactly how Zoho can solve your
              challenges, no pitch, no pressure. Just a working session with someone who's done this 100+ times.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 36 }}>
              {['No commitment required', '100% free consultation', 'Reply within 24 hours'].map(
                (c, idx) => (
                  <div
                    key={c}
                    className="consult-check"
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      gap: 10,
            ...
            >
                ...
                {options.map((opt, i) => (
                  <a
                    ...
                    style={{
                      ...
                      textDecoration: 'none',
                      transition:
                        'transform 0.35s cubic-bezier(0.22,1,0.36,1), box-shadow 0.35s ease, border-color 0.3s',
                      cursor: 'pointer',
                      fontFamily: 'Inter, sans-serif',
                    }}
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 12px 28px ${opt.color}30`
                      const arrow = e.currentTarget.querySelector('.opt-arrow')
                      if (arrow) {
                        arrow.style.color = opt.color
                        arrow.style.transform = 'translateX(6px)'
                      }
                      const ic = e.currentTarget.querySelector('.opt-icon')
                      if (ic) {
                        ic.style.transform = 'rotate(-8deg) scale(1.08)'
                        ic.style.background = `${opt.color}25`
                      }
                    }}
                    onMouseLeave={(e) => {
                      ...
                      if (ic) {
                        ic.style.transform = ''
                        ic.style.background = `${opt.color}15`
                      }
                    }}
                  >
                    <div
                    ...
                    >
                      <i
                        ...
                        style={{ fontSize: '1.2rem', color: opt.color }}
                      />
                    </div>
                    <div style={{ flex: 1 }}>
                      <div
              ...
              >
                <i
                  ...
                  style={{ color: '#1a56db', fontSize: '1rem', flexShrink: 0 }}
                />
                <div
                  style={{
                    fontSize: '0.78rem',
                ...
                >
                  100% free · No spam · Your data is safe with us
                </div>
              </div>
            </div>
          </div>
